...
Following the convention introduced in the ArchesWeather dataset description,
...
that $\mathcal{M}_\pi(x_n)$ represents the area-weighted mean surface
...
\]
over the experimental horizon, with $n=1,\ldots,N$.
