...
Note-taking:
\begin{itemize}
    \item it seems like the gradient is most informative when we only evaluate it once (spike@ instead of spread), and we do it at the t=2. With informativeness we mean in terms of the push charts.
\end{itemize}
